...
import com.durga.blogapp.articles.dtos.CreateArticleRequest;
import com.durga.blogapp.articles.dtos.UpdateArticleRequest;
import com.durga.blogapp.users.UsersRepository;
import com.durga.blogapp.users.UsersService;
...
public class ArticlesService {
    ...
    public ArticleEntity createArticle(CreateArticleRequest a, Long authorId){
        ...
        return articlesRepository.save(ArticleEntity.builder()
                .title(a.getTitle())
                //todo: create a propper slugification function
